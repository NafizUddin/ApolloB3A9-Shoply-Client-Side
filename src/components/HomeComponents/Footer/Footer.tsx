          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              <p className="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left">
                Your shopping experience made easy—Explore our products now!
              </p>
              <a
                href=""
                className="py-2.5 px-5 h-9 block w-fit bg-primary rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-[#c4650a] lg:mx-0"
              >
                Contact us
              </a>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
              <h4 className="text-lg text-primary font-medium mb-7">Shoply</h4>
            ...
            <div className="lg:mx-auto text-left ">
              ...
              <a
                href=""
                className="flex items-center justify-center gap-2 border border-primary rounded-full py-3 px-6 w-fit lg:mx-0 text-sm text-primary font-semibold transition-all duration-500 hover:bg-primary hover:text-white group"
              >
                Subscribe
                <svg
                  width="15"
                ...
                >
                  <path
                    ...
                    className="stroke-[#f5840c] group-hover:stroke-white transition-all duration-500"
                  />
                </svg>
              </a>
            </div>
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-white ">
                ©<a href="https://pagedone.io/">Shoply</a> 2024, All rights
                reserved.
              </span>
              <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                ...
                <a
                  href=""
                  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-[#f5840c] to-[#f5840c]  
                        "
                >
                  <svg
