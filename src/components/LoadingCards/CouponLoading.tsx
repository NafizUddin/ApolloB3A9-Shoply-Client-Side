const CouponLoading = () => {
  return (
    <div className="container border border-primary text-white p-5 rounded-lg shadow-lg max-w-md mx-auto animate-pulse">
      ...
      <div className="bg-gray-700 px-3 py-1 rounded mt-3 w-20">
