...
const CustomerProfileLoading = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center p-6 lg:p-12 bg-gray-800 rounded-lg shadow-lg animate-pulse mt-20">
      {/* Image Skeleton */}
      <div className="lg:order-2 w-full lg:w-1/3 flex justify-center">
        <div className="h-48 w-48 lg:h-80 lg:w-full bg-gray-700 rounded-lg"></div>
      </div>
      ...
      <div className="lg:order-1 w-full lg:w-2/3 mt-6 lg:mt-0 lg:mr-8 space-y-4">
        ...
        {/* Button Skeleton */}
        <div className="h-10 w-40 bg-gray-700 rounded-full"></div>
